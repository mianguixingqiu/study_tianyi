...
var util = {
	...
	musicset: {
		...
		apply: function () {
			util.musicset.load();
			$('meting-js').remove();
			$('#bt_fs').after('<meting-js server="' + util.readMusicconf('platform') + '" type="playlist" id=' + util.readMusicconf('id') + ' fixed="true" theme="#66ccff" order="random" mutex="true" lrc-type="0"> </meting-js>');
